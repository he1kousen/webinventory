...
<div class="page-header">
    <h1 class="page-title">Laporan Barang Hilang</h1>
    <div>
        <ol class="breadcrumb">
...
<script>
    ...
    function print() {
        ...
        if (tglawal != '' && tglakhir != '') {
            window.open(
                "{{route('lap-bh.print')}}?tglawal=" + tglawal + "&tglakhir=" + tglakhir,
                '_blank'
            );
        } else {
            swal({
    ...
    function pdf() {
        ...
        if (tglawal != '' && tglakhir != '') {
            window.open(
                "{{route('lap-bh.pdf')}}?tglawal=" + tglawal + "&tglakhir=" + tglakhir,
                '_blank'
            );
        } else {
            swal({
