            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="customerU" class="form-label">Customer <span class="text-danger">*</span></label>
                            <input type="text" name="customerU" id="customerU" class="form-control" placeholder="Masukkan nama customer">
                        </div>
...
<script>
    ...
    function checkFormU() {
        ...
        if (tglkeluar == "") {
            ...
            $.ajax({
                type: 'GET',
                url: '/admin/barang-keluar/cek-stok/' + kdbarang,
                dataType: 'json',
