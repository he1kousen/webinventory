    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">Ubah Barang Rusak</h6><button aria-label="Close" onclick="resetU()" class="btn-close" data-bs-dismiss="modal"><span aria-hidden="true">&times;</span></button>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="brkodeU" class="form-label">Kode Barang Rusak <span class="text-danger">*</span></label>
                            <input type="text" name="brkodeU" readonly class="form-control" placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="tglRusakU" class="form-label">Tanggal Rusak <span class="text-danger">*</span></label>
                            <input type="text" name="tglrusakU" class="form-control datepicker-date" placeholder="">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="jmlU" class="form-label">Jumlah Rusak <span class="text-danger">*</span></label>
...
<script>
    ...
    function checkFormU() {
        const tglrusak = $("input[name='tglrusakU']").val();
        ...
        if (tglrusak == "") {
            validasi('Tanggal Rusak wajib di isi!', 'warning');
            $("input[name='tglrusakU']").addClass('is-invalid');
            setLoadingU(false);
            return false;
            ...
            validasi('Jumlah Rusak wajib di isi!', 'warning');
