    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">Tambah Barang Rusak</h6><button aria-label="Close" onclick="reset()" class="btn-close" data-bs-dismiss="modal"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="brkode" class="form-label">Kode Barang Rusak <span class="text-danger">*</span></label>
                            <input type="text" name="brkode" readonly class="form-control" placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="tglrusak" class="form-label">Tanggal Rusak <span class="text-danger">*</span></label>
                            <input type="text" name="tglrusak" class="form-control datepicker-date" placeholder="">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="jml" class="form-label">Jumlah Rusak <span class="text-danger">*</span></label>
...
<script>
    ...
    function checkForm() {
        const tglrusak = $("input[name='tglrusak']").val();
