...
use App\Http\Controllers\Admin\BaranghilangController;
...
use App\Http\Controllers\Admin\LapBarangHilangController;
...
Route::group(['middleware' => 'userlogin'], function () {
    ...
    Route::middleware(['checkRoleUser:/lap-barang-masuk,submenu'])->group(function () {
        ...
        Route::get('/admin/barang-keluar/cek-stok/{kode}', [BarangkeluarController::class, 'cekStok']);
    });
    ...
    Route::middleware(['checkRoleUser:/lap-barang-hilang,submenu'])->group(function () {
        // Barang Hilang
        Route::resource('/admin/barang-hilang', \App\Http\Controllers\Admin\BaranghilangController::class);
        Route::get('/admin/barang-hilang/show/', [BaranghilangController::class, 'show'])->name('barang-hilang.getbarang-hilang');
        Route::post('/admin/barang-hilang/proses_tambah/', [BaranghilangController::class, 'proses_tambah'])->name('barang-hilang.store');
        Route::post('/admin/barang-hilang/proses_ubah/{baranghilang}', [BaranghilangController::class, 'proses_ubah']);
        Route::post('/admin/barang-hilang/proses_hapus/{baranghilang}', [BaranghilangController::class, 'proses_hapus']);
    });
    ...
    Route::middleware(['checkRoleUser:/lap-barang-hilang,submenu'])->group(function () {
        ...
        Route::resource('/admin/lap-barang-hilang', \App\Http\Controllers\Admin\LapBarangHilangController::class);
        Route::get('/admin/lapbaranghilang/print/', [LapBarangHilangController::class, 'print'])->name('lap-bh.print');
        Route::get('/admin/lapbaranghilang/pdf/', [LapBarangHilangController::class, 'pdf'])->name('lap-bh.pdf');
        Route::get('/admin/lap-barang-hilang/show/', [LapBarangHilangController::class, 'show'])->name('lap-bh.getlap-bh');
    });
